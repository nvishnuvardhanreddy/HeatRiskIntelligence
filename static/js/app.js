  ...
  window.GZ = {
    ...
    async getBrowserLiveWeather(location) {
      const params = new URLSearchParams({
        ...
        daily: "temperature_2m_min,temperature_2m_max,relative_humidity_2m_mean,wind_speed_10m_max,shortwave_radiation_sum,precipitation_sum",
        forecast_days: "6"
      });
      ...
      const weather = {
        ...
        wind_direction: current.wind_direction_10m, solar_radiation: current.shortwave_radiation,
        pressure: current.surface_pressure, cloud_cover: current.cloud_cover,
        precipitation: current.precipitation, uv_index: current.uv_index,
        dew_point: current.dew_point_2m, source: "Open-Meteo browser live",
        solar_status: "LIVE", data_mode: "BROWSER_LIVE"
      };
